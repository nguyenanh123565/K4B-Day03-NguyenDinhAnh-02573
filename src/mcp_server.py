...
class MCPExpenseServer:
    """
    Giả lập MCP Server quản lý chi tiêu tuân thủ Model Context Protocol.
    """
...
if __name__ == "__main__":
    ...
    test_result = server.call_tool("record_expense", {"amount": 50000, "category": "Ăn uống", "description": "Cà phê", "date": "2026-09-13"})
    print("✅ Test dispatch tool 'record_expense' thành công:")
